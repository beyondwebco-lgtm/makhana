...
import { ArrowLeft, CreditCard, ShoppingBag, Truck, Lock, Check } from "lucide-react";
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-[#111] p-6 sm:p-8 rounded-3xl border border-white/5 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs text-white/50 font-bold uppercase tracking-wider mb-2">Email Address</label>
                    <input
                      type="email"
                      required
                  ...
                  <div>
                    <label className="block text-xs text-white/50 font-bold uppercase tracking-wider mb-2">Phone Number</label>
                    <input
                      type="tel"
                      required
              ...
              <div className="bg-[#111] p-6 sm:p-8 rounded-3xl border border-white/5 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs text-white/50 font-bold uppercase tracking-wider mb-2">First Name</label>
                    <input
                      type="text"
                      required
                      placeholder="John"
                  ...
                  <div>
                    <label className="block text-xs text-white/50 font-bold uppercase tracking-wider mb-2">Last Name</label>
                    <input
                      type="text"
                      required
                      placeholder="Doe"
                ...
                <div>
                  <label className="block text-xs text-white/50 font-bold uppercase tracking-wider mb-2">Street Address</label>
                  <input
                    type="text"
                    required
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-xs text-white/50 font-bold uppercase tracking-wider mb-2">City</label>
                    <input
                      type="text"
                      required
                      placeholder="Mumbai"
                  ...
                  <div>
                    <label className="block text-xs text-white/50 font-bold uppercase tracking-wider mb-2">ZIP Code</label>
                    <input
                      type="text"
                      required
                      placeholder="400001"
