...
export default function FindMyFlavour() {
  ...
  useFocusTrap(modalRef, isModalOpen && step !== "landing");
  ...
  const rayColor = (step === "result" || step === "analyzing")
    ? (THEME_COLORS[recommendedSlug] || THEME_COLORS.default)
  ...
  const computeRecommendation = (finalAnswers: string[]) => {
    ...
    // Pick one deterministically if there's a tie
    const finalBest = bestSlugs[answers.length % bestSlugs.length];
  ...
  useEffect(() => {
    ...
    requestAnimationFrame(() => setAnalysisProgress(0));
    const intervals = [
        ...
        <div className="w-full max-w-3xl relative z-10 flex flex-col items-center justify-center">
          ...
          {step === "landing" && (
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl sm:text-7xl font-black uppercase tracking-[8px] mb-8 leading-[1.25] max-w-2xl font-[family-name:var(--font-accent)] text-white">
            ...
            {isModalOpen && step !== "landing" && (
              ...
              >
                <div 
                  ...
                  role="dialog"
                  aria-modal="true"
                  aria-label="Find My Flavour Wizard"
                  className="w-[95vw] md:w-[88vw] h-[90vh] md:h-[85vh] max-w-[1600px] max-height-[900px] bg-[#111111]/85 border border-white/10 rounded-[2rem] md:rounded-[3rem] p-6 pt-20 md:p-16 shadow-2xl relative overflow-y-auto flex flex-col justify-between backdrop-blur-md"
                >
                    ...
                    {step === "camera" && (
                      ...
                      >
                        ...
                        <div className="lg:col-span-5 flex flex-col justify-center text-left">
                          ...
                          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black uppercase tracking-[6px] mb-6 leading-tight font-accent text-white">
                            Snap Your Selfie
                          </h2>
                    ...
                    {step === "preview" && (
                      ...
                      >
                        ...
                        <p className="text-white/50 text-base max-w-sm font-light tracking-[1px]">
                          Let&apos;s continue to the questions.
                        </p>
                    ...
                    {step === "questions" && (
                      ...
                      >
                        ...
                        <div className="max-w-3xl mb-8 mt-4 pl-2">
                          <h3 className="text-4xl sm:text-4xl md:text-5xl font-black uppercase tracking-[4px] text-white leading-tight font-accent">
                    ...
                    {step === "result" && (
                      ...
                      >
                          ...
                          >
                            ...
                            {(FLAVOUR_STYLING[recommendedSlug]?.ingredients || ["✨", "🌿", "🧂"]).map((icon, idx) => (
                              <motion.div
                                ...
                                className="absolute text-4xl lg:text-4xl md:text-5xl opacity-80 drop-shadow-2xl z-30"
                                style={{
                        ...
                        <div className="flex flex-col justify-center text-left w-full max-w-[650px] mx-auto lg:mx-0 z-20">
                          ...
                          <h2 className="text-4xl sm:text-6xl lg:text-8xl font-black uppercase tracking-[8px] leading-none text-white mb-6 font-accent drop-shadow-lg">
